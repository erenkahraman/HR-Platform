    ...
    <section className="relative w-full">
      <div className="w-full mb-12">
        <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded"
             style={{ width: "539px", height: "232px", left: "282px", top: "769px", borderRadius: "10px", border: "1px solid #dcdde1",
                      background: "linear-gradient(0deg, #DCDDE1, #DCDDE1), linear-gradient(0deg, #FFFFFF, #FFFFFF)" }}>
