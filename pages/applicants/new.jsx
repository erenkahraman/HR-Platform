...
import DocumentReviewRadioRow from "../../components/DocumentReviewRadioRow/DocumentReviewRadioRow";
              ...
              >
                ...
                <div className="flex flex-col gap-6">
                  ...
                  <div className="flex flex-[1] flex-col gap-4 px-4 py-5">
                    ...
                    {/*Photo and Sex*/}
                    <div className="flex grow gap-x-[2rem]">
                      <div className="flex flex-col gap-y-[1.5rem]">
                        ...
                        <fieldset className="flex flex-col gap-2">
                          <legend className="block text-sm">Gender</legend>
                      ...
                      {/*First, last name, Date of Birth and Nationality*/}
                  ...
                  <div>
                    ...
                    <div className="flex flex-col px-4 py-2">
                      <div className="flex justify-evently grow gap-x-[4rem]">
                        <div className="flex flex-[1] flex-row gap-x-[1.5rem]">
                          <div className="flex flex-col grow gap-2 py-5">
                            ...
                            */}
                            {dbDepartment && (
                              <select
                                ...
                                className="block w-[100%] py-2  border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                                onChange={(e) => {
                                  setPositions(
                          ...
                          <div className="flex flex-col grow gap-2 py-5">
                            <label htmlFor="position" className="block text-sm">Position</label>
                            {positions ? (
                                <select
                                ...
                                <div className="block w-[100%] py-2 sm:text-sm font-thin text-red-600">
                        ...
                        <div className="flex flex-[1] flex-row gap-x-[1.5rem]">
                          ...
                          <div className="flex flex-col grow gap-2 py-5">
                            <label htmlFor="departure-date" className="block text-sm">End Date</label>
                            <Controller
                              control={control}
