          ...
          <div className="flex justify-between rounded-t mb-0 px-4 pt-3 border-0 bg-white">
            <div className="flex flex-wrap items-center">
              <div className="relative w-full px-3 max-w-full flex-grow flex-1 ">
                <h3 className="font-semibold text-2xl">Interns Departure</h3>
              </div>
            </div>
            ...
            <div>
              <div className="flex flex-row justify-between font-semibold pl-4 pt-5 pb-10">
                ...
                <div className="pr-3 pl-1.5 pt-3">
                  <input
                    type="radio"
                    className="border-none bg-[#50d71e] read-only:bg-gray-100 p-2"
                  />
                ...
                <div className="pr-3 pl-1.5 pt-3">
                  <input
                    type="radio"
                    className="border-none read-only:bg-gray-100 p-2"
                  />
                    ...
                    <div className="flex flex-row">
                      ...
                      >
                        <div className="flex flex-row">
                          <div>
                            <input
                              className="rounded border-none bg-[#0B3768] text-white align-middle w-36 px-6 text-sm p-4 mx-7"
                              type="text"
                              name="applicant"
                          ...
                          <div>
                            <input
                              className="rounded border-none bg-[#0B3768] text-white align-middle px-6 text-sm p-4 mx-7 "
                              type="date"
                              name="arrivalDate"
                          ...
                          <div>
                            <input
                              className="rounded border-none bg-[#0B3768] text-white align-middle w-36 px-5 text-sm p-4 mx-7"
                              type="text"
                              name="arrivalCity"
