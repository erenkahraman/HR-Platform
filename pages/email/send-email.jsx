	...
	return (
		<div className="flex justify-center" >
			<form className={styles.form} onSubmit={(e) => onSubmitForm(e)}>
				<label for="input-group-1" className="block mb-2 text-sm font-medium text-gray-900 dark:text-black">To:</label>
				...
				<label for="website-admin" className="block mb-2 text-sm font-medium text-gray-900 dark:text-black">Subject:</label>
				<div className="relative mb-6">
					...
					{showErrorText && (
						<p style={{ color: "rgb(255, 0, 0)" }}>
							Please make sure you've entered a <em>non-decimal character</em>
						</p>
					)}
				</div>
				<label for="website-admin" className="block mb-2 text-sm font-medium text-gray-900 dark:text-black">Body:</label>
				<div className="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
					...
					<div className="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800">
						<label for="message" className="sr-only">Publish post</label>
