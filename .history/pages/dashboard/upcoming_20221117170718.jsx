...
const Upcoming = ({ name, department, status, time }) => {
    ...
    const statusText = () => {
        let result = "flex-[1] flex items-center justify-center text-xs";
        return result =
        "flex-[1] flex items-center justify-center text-xs " + statusText;
    };

    const timeText = () => {
        let result = "flex-[1] flex items-center justify-center text-xs";
        return result=
        "flex-[1] flex items-center justify-center text-xs " + timeText;
    };

    const nameText = () => {
        let result = "flex-[2] flex items-center justify-center text-xs";
        return result=
        "flex-[2] flex items-center justify-center text-xs " + nameText;
    };

    const departmentText = () => {
        let result = "flex-[2] flex items-center justify-center text-xs";
        return result=
        "flex-[2] flex items-center justify-center text-xs " + departmentText;
    };
