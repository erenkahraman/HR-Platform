...
const Dashboard = () => {
  ...
  <div className="flex h-screen justify-center items-center ">
    <div className="flex-col justify-center bg-[#0b3768] py-8 px-10 border-4 border-none rounded-xl px-5">
      <div className="flex mb-5">
        <p className="font-semibold text-2xl text-white">Weekly Schedule</p>
      </div>
      <div className="flex flex-row"> {/* Use flex-row to display morning and afternoon shifts side by side */}
        <div>
