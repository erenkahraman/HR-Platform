	...
	return (
		<div className="flex justify-center" >
			<form className={styles.form} onSubmit={(e) => onSubmitForm(e)}>
				<label for="input-group-1" class="block mb-2 text-sm font-medium text-gray-900 dark:text-black">To:</label>
				<div class="relative mb-6">
					...
					<input id='emailTo'
						...
						placeholder=''
						required class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
				</div>
				<label for="website-admin" class="block mb-2 text-sm font-medium text-gray-900 dark:text-black">Subject:</label>
				<div class="relative mb-6">
				...
				<label for="website-admin" class="block mb-2 text-sm font-medium text-gray-900 dark:text-black">Body:</label>
				<div class="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
					...
					<div class="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800">
						...
						<textarea id="message" onChange={handleChange} value={inputs.message} rows="8" class="block w-full px-0 text-sm text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Write a message..." required></textarea>
					</div>
				</div>
				<div class="items-center">

					<input type='submit' value="Submit" class="inline-flex w-50 items-center px-5 py-2.5 text-sm font-medium text-center text-white bg-blue-700 rounded-lg focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-900 hover:bg-blue-800" />
					{form.state === 'loading' ? (
						<div>Sending....</div>
					) : form.state === 'error' ? (
