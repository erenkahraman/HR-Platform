...
const WeeklySchedule = () => {
  ...
  return (
    <section className="flex-1  min-h-screen w-full bg-gray-100  ">
      <div className="w-full  max-w-screen mx-auto flex-grow">
        <div className="absolute flex flex-col  items-center justify-center min-w-0 break-words w-full rounded">
