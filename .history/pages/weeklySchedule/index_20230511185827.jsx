    ...
    <section className="relative w-full min-h-screen bg-gray-100">
      <div className="w-full max-w-screen mx-auto">
        <div className="relative flex flex-col items-center justify-center min-w-0 break-words w-full shadow-lg rounded bg-white">
          ...
          <div className="px-4 py-6 flex justify-start items-start gap-12" style={{ width: "1090px", height: "409px" }}>
            <div className="flex-none">
              <h2 className="font-roboto font-medium text-2xl text-black text-center w-full mb-4">IT</h2>
              <div className="font-roboto text-lg text-black">Eren</div>
            </div>
            <div className="flex-none">
              <h2 className="font-roboto font-medium text-2xl text-black text-center w-full mb-4">UEX</h2>
