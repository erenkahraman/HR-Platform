          ...
          >
            ...
            >
              ...
              <tr>
                ...
                <td>Backend</td>
                <td>
                  <div className="display: "flex", flexDirection: "row", alignItems: "flex-start", padding: "0px", gap: "24px", width: "559px", height: "24px"">
                  <Button className="move-button px-20" style={{ display: "flex", flexDirection: "row", alignItems: "flex-start", padding: "4px 12px", gap: "10px", width: "145px", height: "24px", background: "#FFFFFF", borderRadius: "10px", color: "black" }}>
                        Move to Afternoon
                      </Button>
                    <Button className="move-button px-20" style={{ display: "flex", flexDirection: "row", alignItems: "flex-start", padding: "4px 12px", gap: "10px", width: "145px", height: "24px", background: "#FFFFFF", borderRadius: "10px", color: "black" }}>
                        Move to Afternoon
              ...
              <tr>
                ...
                <td>Mobile</td>
                <td>
                <div className="button-container" style={{ display: "flex", flexDirection: "row", alignItems: "flex-start", padding: "0px", gap: "24px", width: "559px", height: "24px" }}>
                      <Button className="move-button px-20" style={{ display: "flex", flexDirection: "row", alignItems: "flex-start", padding: "4px 12px", gap: "10px", width: "145px", height: "24px", background: "#FFFFFF", borderRadius: "10px", color: "black" }}>
                        Move to Morning
                      </Button>
                      <Button className="move-button px-20" style={{ display: "flex", flexDirection: "row", alignItems: "flex-start", padding: "4px 12px", gap: "10px", width: "145px", height: "24px", background: "#FFFFFF", borderRadius: "10px", color: "black" }}>
