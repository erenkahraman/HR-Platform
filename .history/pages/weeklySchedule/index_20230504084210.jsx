    ...
    <div className="flex flex-col items-center justify-center min-h-screen py-2">
      ...
      <main className="flex flex-col items-center justify-center flex-1 px-20 text-center">
        ...
        <div className="flex flex-wrap items-center justify-around max-w-4xl mt-6 sm:w-full">
          ...
          <div className="flex flex-col items-center justify-center p-6 mt-6 text-left border w-96 rounded-xl">
            <h2 className="text-2xl font-bold">Remove Schedule</h2>
            <div className="flex flex-col items-center justify-center p-6 mt-6 text-left border w-96 rounded-xl">
              <h2 className="text-2xl font-bold">Edit Schedule</h2>
              <div className="flex flex-col items-center justify-center p-6 mt-6 text-left border w-96 rounded-xl">
                <h2 className="text-2xl font-bold">Swap Schedule</h2>
                <div className="flex flex-col items-center justify-center p-6 mt-6 text-left border w-96 rounded-xl">
                  <h2 className="text-2xl font-bold">Match Group</h2>
                  <div className="flex flex-col items-center justify-center p-6 mt-6 text-left border w-96 rounded-xl">
                    <h2 className="text-2xl font-bold">Match Intern</h2>
                  </div>
                </div>
              </div>
            </div>
