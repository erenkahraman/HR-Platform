          ...
          >
            ...
            >
               ...
               <td></td>
                <td>
                  <div className="button-container px-20">
                    <Button className="move-button " style={{ backgroundColor: 'white', borderRadius: '10px', marginRight: '20px' }}>Move to Morning</Button>
                    <Button className="move-button " style={{ backgroundColor: 'white', borderRadius: '10px', marginRight: '20px' }}>Move to Afternoon</Button>
                  </div>
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td>
                  <div className="button-container px-20">
                    <Button className="move-button " style={{ backgroundColor: 'white', borderRadius: '10px' }}>Move to Morning</Button>
                    <Button className="move-button " style={{ backgroundColor: 'white', borderRadius: '10px', }}>Move to Afternoon</Button>
                  </div>
                </td>
              </tr>
              </tbody>
