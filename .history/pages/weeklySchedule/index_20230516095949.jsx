          ...
          >
            ...
            >
              ...
              <tr>
                ...
                <td>
                  <div className="button-container px-20">
                    <Button className="move-button px-20" style={{ backgroundColor: 'white', borderRadius: '10px' }}>Move to Morning</Button>
                    <Button className="move-button px-20" style={{ backgroundColor: 'white', borderRadius: '10px' }}>Move to Afternoon</Button>
                  </div>
                </td>
              </tr>
              </tbody>
