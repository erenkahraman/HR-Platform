          ...
          <div className="mt-10">
            ...
            >
              ...
              <tr>
                ...
                <td>
                  <div className="button-container">
                    <Button className="px-5 align-middle border border-solid py-3 text-sm uppercase border-l-0 border-r-0 whitespace-nowrap font-semibold text-left">Move to Morning</Button>
                    <Button className="move-button">Move to Afternoon</Button>
                  </div>
                </td>
              </tr>
