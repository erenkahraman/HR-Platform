...
const WeeklySchedule = () => {
  ...
  return (
    <section className="flex-1 w-full min-h-screen bg-gray-100  ">
      <div className="w-full max-w-screen w-full ">
        <div className="relative flex flex-col w-full items-center justify-center min-w-0 break-words w-full rounded">
