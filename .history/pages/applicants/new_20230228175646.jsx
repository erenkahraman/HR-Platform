...
export default function ApplicantsNew() {
  ...
  const [listNameUniversity,setListNameUniversity] = useState([]);
  var list = ['Académie de Paris', "Académie d'Aix-Marseille", 'Marywood University', 'University of Petroleum and Energy Studies', 'Cégep de Saint-Jérôme', 'Lindenwood University', 'DAV Institute of Engineering & Technology', 'Lovely Professional University', 'Sullivan University', 'Florida State College at Jacksonville', 'Xavier University', 'Tusculum College', 'Claremont School of Theology', 'Somaiya Vidyavihar', 'Columbia College (SC)', 'Chabot-Las Positas Community College District', 'Keller Graduate School of Management', 'Monroe College', 'San Mateo County Community College District', 'Los Rios Community College District', 'DigiPen Institute of Technology', 'University of Pittsburgh Medical Center', 'Claremont Graduate University', 'University of Texas Rio Grande Valley', 'College of Mount Saint Vincent', 'University of Arkansas System eVersity', 'ECPI University', 'University of Mary Washington', 'Baldwin Wallace University', 'California State University Channel Islands', 'Brandman University', 'United States Coast Guard Academy', 'Athens State University', 'The Scripps Research Institute', 'Eastern Florida State College', 'Western New England University', 'King University', 'Georgia Gwinnett College', 'Trident University', 'Alliant International University', 'Mississippi Valley State University', 'Roosevelt University', 'ITT Technical Institute', 'Illinois Eastern Community Colleges', 'Park University', 'Icahn School of Medicine at Mount Sinai', 'Utah Valley Uniersity', 'Wisconsin Lutheran College', 'Riverside Community College District', 'Wake Forest Baptist Health',];
  ...
  const getDataUniversity=()=>{
   ...
   useEffect(()=>{
       ...
       dataUniversity.map((univ) => {
        setListNameUniversity(current => current.concat(univ.name))
       })
      },[])
    console.log(listNameUniversity)
                  ...
                  <div className="flex flex-[1] flex-col gap-4 px-4 py-5">
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      <p className="text-sm font-thin text-red-600">
                       ...
                       {/*<Autocomplete
                            suggestions={listNameUniversity}
