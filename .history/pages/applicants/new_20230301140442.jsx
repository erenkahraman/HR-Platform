...
import file from "../../public/university_list.json";
...
export default function ApplicantsNew() {
  ...
  var newArray = [];
        var newArray = file.data.filter(function(elem, pos) {
                return file.data.indexOf(elem) == pos;
        });
        console.log(newArray);
  /*const getDataUniversity=()=>{
    fetch('/university_list.json'
    ,{
      headers : { 
