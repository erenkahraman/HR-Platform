...
function Attendence() {
  ...
  const handleRefreshTable = () => { 
    ...
    const resreshData = data.map((eachStudent) => {
      const attendanceInfo = getAttendanceInfoOfStudent(eachStudent)
      return { ...eachStudent, ...attendanceInfo }
    })
    ...
    const refreshedData = data.map(student => ({
      ...
      intern: {
        ...
        attendance: {
          ...
          present: {
            ...student.intern.attendance.present,
            count: 0,
            dates: []
          },
          late: {
            ...student.intern.attendance.late,
            count: 0,
            dates: []
          },
          coveredDay: {
            ...student.intern.attendance.coveredDay,
            count: 0,
            dates: []
          },
          dayOff: {
            ...student.intern.attendance.dayOff,
            count: 0,
            dates: []
          },
          excusedLeave: {
            ...student.intern.attendance.excusedLeave,
            count: 0,
            dates: []
          },
          sick: {
            ...student.intern.attendance.sick,
            count: 0,
            dates: []
          },
          unexcusedleave: {
            ...student.intern.attendance.unexcusedleave,
            count: 0,
            dates: []
          }
        }
