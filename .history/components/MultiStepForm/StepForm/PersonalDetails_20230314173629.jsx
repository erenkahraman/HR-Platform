...
export const PersonalDetails = ({ formData, setForm, navigation }) => {
  ...
  const controlRegex = (str) => {

    if( str === "" || !regex.test(str)) return true;
          ...
          <TextField
           error = {controlRegex(lastName)}
            ...
            helperText={lastName === "" ? "Please enter a last name.": 
                      !regex.test(lastName) ? "The name must not contain numbers":""}
            autoComplete="off"
            fullWidth
          />
