...
export const Contact = ({ formData, setForm, navigation }) => {
  const {  email,university } = formData;
  ...
  /> */}
      ...
      <MuiTelInput disabled={ isPhoneValid ? true : false} fullWidth value={value} style={{outline : isPhoneValid ? "2px solid green" : "2px solid red"}} onChange={handleChange} />
       <TextField
        label="University"
        name="university"
        value={university}
