...
export const Contact = ({ formData, setForm, navigation }) => {
  ...
  /> */}
      ...
      <MuiTelInput disabled={value != "" && isPhoneValid ? true : false} fullWidth value={value} style={{outline : isPhoneValid ? "2px solid green" : "2px solid red"}} onChange={handleChange} />
       <TextField
        label="University"
        name="university"
        value={university}
