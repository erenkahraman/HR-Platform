...
return (
  <div style={{departmentColor(department)}} className="flex flex-row ml-5">
    <div className="flex flex-row gap-2">
      <BsPeopleFill className="text-2xl" />
      <div className="flex flex-col gap-2">
        <h3 className="text-lg font-semibold">{department.department}</h3>
        <h3 className="text-sm font-semibold">{department.interns.length} Interns</h3>
      </div>
    </div>
  </div>
)

// let departmentColor = (department) => {
//   let color = "";
//   switch (department) {
//     case "Software":
//       color = "text-blue-400";
            ...
            {departments.map((department) => (
              <div className="flex flex-row ml-5">
                <div className="text-red-400 ">
                  <BsPeopleFill 
                  className={departmentColor(department.department)}
                  />
                </div>
