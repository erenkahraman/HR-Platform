...
if (department.interns.length < 2) {
  department.intern.variant = "red";
} else if (department.interns.length < 3) {
  department.intern.variant = "green";
} else if (department.interns.length < 4) {
  department.intern.variant = "blue";
} else {
  department.intern.variant = "gray";
}
