...
const InternView = () => {
  ...
  department.map((dep, index) => (
    <div  className={Border(dep.department)}>
      ...
      <tr>
          <th className="px-6 align-middle  w-full border border-solid py-3 text-xs uppercase border-l-0 border-r-0 whitespace-nowrap font-semibold text-center"> 
              {dep.department}
          </th>
