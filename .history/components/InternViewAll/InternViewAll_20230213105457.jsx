...
import EditDocumentsModal from "../Modal/EditDocumentsModal";
    ...
    const Border = (title) => {
      ...
      let result =
        "flex flex-col w-full py-2 px-6 gap-2 bg-white border items-center rounded-md " +
        statusColor;
      return result;
    };
        ...
        <div className="flex gap-4 items-center">
          <div className="flex font-semibold">
            ...
            <table className="items-center w-full border-collapse ">
              <thead>
                  <tr>
                      <th colspan="2" className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 bg-gray"> 
                          {dep.department}
                          </th>
                  </tr>
              </thead>
