        ...
        >
          ...
          <div className="m-2 p-4">
            <form onSubmit={handleSubmitReminder}>
              <div>
                <h6 className="font-semibold text-xl text-blue-700 pt-2 pb-4 border">
                 Upload File
                </h6>
              ...
              {/* BUTTOM PART */}
                ...
                <div className="flex space-center">
                  ...
                  <button class="bg-transparent hover:bg-blue-500 text-blue-700 border-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded" >
                    Upload
                  </button>
