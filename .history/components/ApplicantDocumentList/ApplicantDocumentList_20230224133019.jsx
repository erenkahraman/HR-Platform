...
const url = 'GFG.txt';
  ...
  https.get(url,(res) => {
    ...
    const path = "C:/Users/thoma/OneDrive/Documents/GitHub/HRplatform/public/uploads/students/Eren_KAHRAMAN/"+dt.data.file;
  ...
  //saveAs("../../public/uploads/students/Eren_KAHRAMAN/"+dt.data.file,
  //dt.data.file)
  var obj = URL.createObjectURL("C:/Users/thoma/OneDrive/Documents/GitHub/HRplatform/public/uploads/students/Eren_KAHRAMAN/"+dt.data.file);
  console.log(obj)
 
  /*setFullPath("uploads/students/Eren_KAHRAMAN/"+dt.data.file);
  const hiddenTag = document.querySelector("#hiddenTag");
  console.log("uploads/students/Eren_KAHRAMAN/"+dt.data.file);
  console.log(hiddenTag);
  hiddenTag.click();*/

    
   
    //dowload(fileUrl, filename)
