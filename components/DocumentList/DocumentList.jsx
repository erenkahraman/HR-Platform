...
const Contents = [
	...
	{ title: "Curiculum Vitae", pos: "left", status: "correct", icon: <CheckCircleOutline className="text-sm"/>},
	{ title: "Learning Agreement", pos: "mid", status: "correct" , icon:<CheckCircleOutline className="text-sm"/>},
	{ title: "Acceptance Letter", pos: "mid", status: "null" , icon:<AccessTime className="text-sm"/>},
	{ title: "Accommodation L .", pos: "mid", status: "review" , icon:<Visibility className="text-sm"/>},
	{ title: "Arrival Tickets", pos: "mid", status: "null" , icon:<AccessTime className="text-sm"/>},
	{ title: "Intern Dev Plan", pos: "mid", status: "incorrect", icon:<ErrorOutline className="text-sm"/>},
	{ title: "Confidentiality L .", pos: "mid", status: "null" , icon:<AccessTime className="text-sm"/>},
	{ title: "Identification", pos: "mid", status: "incorrect", icon:<ErrorOutline className="text-sm"/> },
	{ title: "Grant", pos: "mid", status: "review" , icon:<Visibility className="text-sm"/>},
	{ title: "Extramus Email", pos: "mid", status: "correct", icon:<CheckCircleOutline className="text-sm"/> },
	{ title: "Extramus Folder", pos: "right", status: "null", icon:<AccessTime className="text-sm"/> },
];
			...
			<div className="flex justify-between">
				...
				<div className="flex gap-2">
					...
					<div className="">
					   ...
					   <Tooltip className="bg-transparent text-black"
                               content="Edit"
                               animate={{
                               mount: { scale: 1, y: 0 },
                               unmount: { scale: 0, y: 25 },
                       }}>
                        <Button onClick={handleOpen} variant="gradient" className="text-black bg-transparent scale-100 hover:scale-125 p-0 cursor-pointer text-xl"><MdOutlineModeEditOutline  /></Button>
                       </Tooltip>
      
      <Dialog open={open} handler={handleOpen} className="fixed  w-2/3 h-2/3 ml-64 px-80 p-0 pl-8 mt-32 border-2 border-[#0B3768] rounded-xl shadow-lg shadow-[#0B3768]" >
		  ...
		  >
			...
			<div className="flex justify-between">
				...
				<div className="flex cursor-pointer">
					...
					<a href="./news"
					>
					 <button className="text-xl text-black transition ease-in-out delay-150 rounded-xl hover:-translate-y-1 hover:scale-110 hover:text-blue-500 hover:shadow-xl hover:shadow-blue-500  duration-300"><ArrowRightAlt /></button> 
					</a>
