            ...
            <div className="flex-col justify-center  bg-[#36648c] py-12 px-24 border-4  rounded-xl ">
              ...
              <div className="flex  gap-2 mb-4">
                ...
                <select
                  ...
                  onClick={e => setPositions(departments[e.target.selectedIndex].positions)}
                >
              ...
              <div className="flex  flex-row ml-6">
                ...
                <button
                  type="submit"
                  className={spinnerState ? "rounded px-4 py-2 ml-4 text-white bg-gray-400 " : "rounded px-4 py-2 ml-4 text-white bg-[#009147] "}
